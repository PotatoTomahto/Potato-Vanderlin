...
#define HYDRATION_LEVEL_WATER_LOGGED 800
...
#define NUTRITION_LEVEL_START_MIN NUTRITION_LEVEL_WELL_FED
#define NUTRITION_LEVEL_START_MAX NUTRITION_LEVEL_FAT

#define HYDRATION_LEVEL_START_MIN HYDRATION_LEVEL_HYDRATED
#define HYDRATION_LEVEL_START_MAX HYDRATION_LEVEL_WATER_LOGGED
