...
DEFINE_BITFIELD(spell_flags, list(
	"SPELL_IGNORE_SPELLBLOCK" = SPELL_IGNORE_SPELLBLOCK,
	"SPELL_RITUOS" = SPELL_RITUOS,
	"SPELL_PSYDON" = SPELL_PSYDON,
	"SPELL_TEMPORARY" = SPELL_TEMPORARY,
	"SPELL_UNETCHABLE" = SPELL_UNETCHABLE,
	"SPELL_DEVIL_BLOCKED" = SPELL_DEVIL_BLOCKED,
))
...
DEFINE_BITFIELD(rights, list(
	...
	"R_SOUND" = R_SOUND,
	"R_SPAWN" = R_SPAWN,
	"R_AUTOADMIN" = R_AUTOADMIN,
	"R_WATCH" = R_WATCH,
	"R_DBRANKS" = R_DBRANKS,
))

DEFINE_BITFIELD(include_rights, list(
	"R_BUILD" = R_BUILD,
	"R_ADMIN" = R_ADMIN,
	"R_BAN" = R_BAN,
	"R_FUN" = R_FUN,
...
DEFINE_BITFIELD(exclude_rights, list(
	"R_BUILD" = R_BUILD,
	"R_ADMIN" = R_ADMIN,
	"R_BAN" = R_BAN,
	"R_FUN" = R_FUN,
...
DEFINE_BITFIELD(can_edit_rights, list(
	"R_BUILD" = R_BUILD,
	"R_ADMIN" = R_ADMIN,
	"R_BAN" = R_BAN,
	"R_FUN" = R_FUN,
